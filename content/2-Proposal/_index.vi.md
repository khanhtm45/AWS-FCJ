...
1. _Thu thập các yêu cầu và chức năng của hệ thống_
2. _Tính toán chi phí và kiểm tra tính khả thi_
3. _Thiết kế giao diện mẫu bằng figma_
4. _Xây dựng các thuộc tính của database_
5. _Xây dựng giao diện wed(frontend)_
6. _Xây dụng API, Backend, tích hợp các dịch vụ aws_
7. _Phát triển, kiểm thử, và triển khai dự án_
